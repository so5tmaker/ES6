/*
А почему в массив нельзя записывать элементы разных типов?

Потому что тогда ячейки будут разного размера, 
и у тебя не получится простым арифметическим вычислением по индексу элемента узнать его адрес. 
Ведь тебе для этого нужно знать, сколько ячеек какого размера стоит на индексах с 0 по 8.

https://practicum.yandex.ru/trainer/algorithms/lesson/6093c5bd-7bd1-401b-b61f-c0d85f96a24d/
 */
